                ...
                <div class="mt-4 text-gray-900">
                    <div class="p-2 border border-gray-300 mb-4">
                        ...
                        <div class="border-t border-gray-200 mt-2 p-2 select-text">
                            <div class="main-box">
                            <h4 class="payment-titlte">Thanh toán thành công!</h4>
                            <p>Cảm ơn bạn đã tin tưởng và ủng hộ dịch vụ của Shop</p>
                            <p>Đừng quên giới thiệu đến bạn bè đến với Shop nhé.</p>

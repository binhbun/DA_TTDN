                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">ID 1s </label>
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="idkey_1s" value="<?=$CMSNT->site('idkey_1s');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label">Key 1S</label>
                                <div class="col-sm-9">
                                    <div class="form-line">
                                        <input type="text" name="keykey_1s" value="<?=$CMSNT->site('keykey_1s');?>"
                                            class="form-control">
                                    </div>
                                </div>
                            </div>
